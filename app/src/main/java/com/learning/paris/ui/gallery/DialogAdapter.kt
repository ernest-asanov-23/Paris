...
class ResponseOptionViewHolder(itemView: ConstraintLayout): RecyclerView.ViewHolder(itemView) {
    private val titleView: TextView = itemView.findViewById(R.id.titleView)
    private val bodyView: TextView = itemView.findViewById(R.id.bodyView)
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        ...
        return when (viewType) {
            ...
            RESPONSE_OPTION_TYPE -> {
                ...
                ResponseOptionViewHolder(itemView as ConstraintLayout)
            }
    ...
    override fun onBindViewHolder(holder: RecyclerView.ViewHolder, position: Int) {
        when (holder) {
            is BotMessageViewHolder -> {
                ...
                val bot = bots.find { message.senderId == it.id } ?: return
